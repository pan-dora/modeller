...
public final class IIIFPathTemplate extends Type {
    ...
    public static final IIIFPathTemplate BASE_URI_PATH = new IIIFPathTemplate(0,
            "/{FedoraAppRoot}/{RestServletURI}/");
    ...
    public static final IIIFPathTemplate COLLECTION_ID_PATH =
            new IIIFPathTemplate(2,
                    "/{FedoraAppRoot}/{RestServletURI}/{collectionRoot}/{collectionID}/");
    public static final IIIFPathTemplate OBJECT_ID_PATH =
            new IIIFPathTemplate(3,
                    "/{FedoraAppRoot}/{RestServletURI}/{collectionRoot}/{collectionID}/{objectID"
                            + "}/");
