...
public class RDFCollectionWriter {
    ...
    RDFCollectionWriter(final List<String> idList, final String collectionPredicate,
        ...
        for (final String id : idList) {
            ...
            if (pos == 0 && (Objects.equals(id, lastId))) {
                ...
                final Property p1 = model.createProperty(String.valueOf(RDF_First));
                final Resource o1 = model.createResource(objectURI);
                model.add(s1, p1, o1);
    ...
    public static class RDFCollectionBuilder {
         ...
         * @return this
         */
        public RDFCollectionWriter.RDFCollectionBuilder idList(final List<String> idList) {
            this.idList = idList;
            return this;
        }
