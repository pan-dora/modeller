...
public class PatchListFrame extends JFrame implements ActionListener {
    ...
    private void initStandardCommands() {
        finishCommand = new ActionCommand(getFinishCommandId()) {
            ...
            public void doExecuteCommand() {
                ...
                new OkPatchListHandler().actionPerformed(null);
        ...
        cancelCommand = new ActionCommand(getCancelCommandId()) {
            ...
            @Override
            public void doExecuteCommand() {
                new CancelPatchListHandler().actionPerformed(null);
            }
        };
    }
    ...
    private class OkPatchListHandler extends AbstractAction {
        ...
        public void actionPerformed(final ActionEvent e) {
            setVisible(false);
            final String listService = listServiceField.getText().trim();
            bagView.getBag().setListServiceBaseURI(listService);
            bagView.patchListHandler.execute();
        }
    }

    private class CancelPatchListHandler extends AbstractAction {
        private static final long serialVersionUID = 1L;
